...
class Scotch(Package):
    ...
    variant('esmumps', default=True, description='Activate the compilation of esmumps needed by mumps')
    variant('shared', default=True, description='Build a shared version of the library')
    variant('metis', default=False, description='Build metis and parmetis wrapper libraries')
