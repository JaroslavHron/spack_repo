...
class Mumps(Package):
    ...
    variant('ptscotch', default=True, description='Activate PT-Scotch as a possible ordering library')
    variant('metis', default=True, description='Activate Metis as a possible ordering library')
    ...
    variant('complex', default=False, description='Activate the compilation of cmumps and/or zmumps')
